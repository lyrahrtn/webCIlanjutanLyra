      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="<?= base_url()?>profile"><img src="<?= base_url()?>assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
              	  <h5 class="centered">Marcel Newman</h5>
              	  	
                  <li class="mt">
                  <a class="active" href="<?= base_url()?>index.php">
                          <i class="fa fa-dashboard"></i>
                          <span>Home</span>
                      </a>
                      <a class="active" href="<?= base_url()?>index.php/user/data_diri">
                          <i class="fa fa-dashboard"></i>
                          <span>Data Diri</span>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/general">General</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/buttons">Buttons</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/panels">Panels</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/calendar">Calendar</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/gallery">Gallery</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/todo_list">Todo List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/blank">Blank Page</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/login">Login</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/lock_screen">Lock Screen</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/form_component">Form Components</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/basic_table">Basic Table</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/responsive_table">Responsive Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="<?= base_url()?>javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="<?= base_url()?>index.php/user/morris">Morris</a></li>
                          <li><a  href="<?= base_url()?>index.php/user/chartjs">Chartjs</a></li>
                      </ul>
                  </li>
